function New-OHShortcut {
    ...
    Specifies the location for creating desktop shortcuts.

    By default, the shortcut is placed in the public (all users) desktop. Including this switch will create the shortcut on the logged-in user's desktop.
    If deploying this script under a 'SYSTEM' account, this switch is unnecessary.

    .PARAMETER UseLoggedInUsersStartMenu
    Specifies the location for creating start menu shortcuts.

    By default, the shortcut is placed in the all users start menu. Including this switch will create the shortcut in the logged-in user's start menu.
    If deploying this script under a 'SYSTEM' account, this switch is unnecessary.
    
    .EXAMPLE
    New-OHShortcut -ShortcutName "Notepad" -TargetPath "C:\Windows\System32\notepad.exe" -AddLocation Desktop -IconLocation "C:\Windows\System32\notepad.exe" -UseLoggedInUsersDesktop -UseLoggedInUsersStartMenu
    Creates a shortcut to Notepad on the logged in user desktop and logged in users start menu.
    ...
    Creates a shortcut to Calculator in the all users Start menu.
    ...
    Creates a shortcut to MyApp on the public desktop and in the all users Start menu.
    ...
    Replaces the shortcut to MyApp on the public desktop and in the all users Start menu.
    
    .EXAMPLE
    New-OHShortcut -ShortcutName "MyApp" -DeleteLocation Both
    Deletes the shortcut to MyApp on the public desktop and in the all users Start menu.
